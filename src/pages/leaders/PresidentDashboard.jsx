          ...
          <section className="mt-8 grid gap-6 xl:grid-cols-3">
            ...
            <article className="rounded-xl border border-slate-200 bg-white shadow-sm">
              <div className="border-b border-slate-200 p-6">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Candidate applications waiting
                  for your decision.
                </p>
              </div>
              ...
              <div className="p-6">
                <div className="rounded-lg bg-slate-50 p-6 text-center">
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    Applications awaiting final
                    endorsement
                  </p>
                </div>

                <p className="mt-5 text-sm text-slate-500">
                  This section will become active
                  when the endorsement service and
                  database policies are connected.
                </p>

                <button
                  type="button"
                  disabled
                  className="mt-5 w-full cursor-not-allowed rounded-lg bg-slate-300 px-5 py-3 font-semibold text-slate-500"
                >
                  View Endorsements
                </button>
              </div>
